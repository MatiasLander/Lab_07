...
The graph is left skewed, meaning that most students gave their teachers a high score, with the majority choosing 4 or higher, as is shown by the mean being 4.17, and the median being 4.3. This shows that the students give the teachers a high score, meaning they enjoy most of their classes. This would make sense as they are now in university and should enjoy the subject they are taking and share the same interests and passions of the teachers for the subject. 
...
*The scatter plot shows a plot of the score and bty_avg, with discrete values clearly apparent, due to the neat rows and columns. The jitter command aims to transform the discrete data into continous data by adding an element of random variation to the location of each point. The initial scatter plot was misleading because it only contained discrete values, therefore the points could only lie on set lines, ruining the purpose of a scatterplot.*
